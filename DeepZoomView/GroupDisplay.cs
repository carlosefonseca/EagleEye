...
namespace DeepZoomView {
	...
	public class GroupDisplay {
		...
		private RectWithRects FindGroupsForWastedSpace(IEnumerable<Group> groups, RectWithRects rect) {
		...
		private void MakeRectsForGroupsToFillSide(RectSide side, IEnumerable<Group> l, double fixedLength, RectWithRects r) {
			double position;
			position = 0;
